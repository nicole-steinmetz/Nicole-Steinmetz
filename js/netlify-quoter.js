/* Netlify quote builder.
   Source: Nicole — Pricing Page (Netlify) v1.html.
   Prices from figma-cursor-netlify-quote-builder.pdf. Vanilla only. */
(function () {
  ...
  var BASELINES = {
    starter: { label: "Starter Build Core", price: 890 },
    standard: { label: "Standard Build Core", price: 3250 }
  };
  var HOURLY_RATE = 70;
