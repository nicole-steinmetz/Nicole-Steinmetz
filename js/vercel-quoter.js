/* Vercel quote builder.
   Source: Nicole — Pricing Page (Vercel) v1_1.html.
   Prices from Knee Coal Website Pricing 2026 (Tier 03) and
   knee-coal-vercel-builder.pdf. Vanilla only. */
(function () {
  ...
  function update() {
    var lines = [
      { label: "Custom Build Core", amount: BASELINE_PRICE },
      { label: "Claude Pro", amount: 102 },
    ...
    var addOnLabels = {
      ...
      "blog-post": "Blog Post Upload", integration: "Integration with Common Software",
      "external-link": "Simple External Link", popup: "Popup / Modal Setup",
      logo: "Logo Redesign Package"
    };
    var stepperPrices = {
      "page-low": 95, "page-standard": 135, "page-complex": 275, "page-legal": 70,
      "ai-copy": 45, "blog-post": 30, integration: 145, "external-link": 20
    };
